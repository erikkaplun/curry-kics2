...
has write permission. The requires the setting of the option
\begin{lstlisting}
GLOBALINSTALL=no
\end{lstlisting}
in the \code{Makefile} of the KiCS2 installation.
