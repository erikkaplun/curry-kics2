...
Version of December 13, 2011\\[6ex]
\Large
...
Each operation \code{fromHaskellIO$n$}
maps a Haskell I/O action into a Curry I/O action and performs
all data conversions for the arguments and result.
...
external_d_C_prim_printString :: CP.OP_List CP.C_Char -> ConstStore
                              -> CP.C_IO CP.OP_Unit
external_d_C_prim_printString s _ = fromHaskellIO1 putStrLn s
\end{curry}
