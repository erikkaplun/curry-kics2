...
\begin{haskell}
  $\ldots$
  printValsDFS (Guard cs x) = do consistent <- add c
...
like in logic programming systems. For instance, KiCS2 evaluates the 
...
In contrast to the Curry implementations PAKCS and MCC, our approach 
of strict unification is based
