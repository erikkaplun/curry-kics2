...
\begin{abstract}
In this paper we present our first results of a new system % first steps towards ?
...
or it is defined by rules with only one constructor in each rule, and
in the same argument for all rules.
...
% Benchmarks from April 11 on climens
...
%parallel (1 proc.)   &    5.46  &         6.29  & $\infty$ \\
%parallel (2 proc.)   &    3.16  &         3.49  & $\infty$ \\
\hline
\end{tabular}
